# Blood Omen: Legacy of Kain Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/blood-omen-legacy-of-kain-recomp/total)](https://github.com/Alexbeav/blood-omen-legacy-of-kain-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/blood-omen-legacy-of-kain-recomp/latest/total)](https://github.com/Alexbeav/blood-omen-legacy-of-kain-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/blood-omen-legacy-of-kain-recomp)](https://github.com/Alexbeav/blood-omen-legacy-of-kain-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Blood Omen: Legacy of Kain** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Blood Omen: Legacy of Kain.
...
Zip prefix for CI artifacts: `Blood-Omen-Legacy-of-Kain-Recomp`.
...
The `v0.3.3` source uses `Blood_Omen__Legacy_of_Kain_Recompiled` in CMake, the setup relaunch, and the packager.
