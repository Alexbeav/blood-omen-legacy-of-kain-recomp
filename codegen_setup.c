...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Blood Omen: Legacy of Kain",
    .project_root_env = "BLOOD_OMEN__LEGACY_OF_KAIN_RECOMP_PROJECT_ROOT",
    .build_dir_env = "BLOOD_OMEN__LEGACY_OF_KAIN_RECOMP_BUILD_DIR",
    .force_setup_env = "BLOOD_OMEN__LEGACY_OF_KAIN_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_000.27_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Blood_Omen__Legacy_of_Kain__Recompiled",
    .prepare_note =
